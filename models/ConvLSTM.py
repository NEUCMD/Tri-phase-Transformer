...
class Model(nn.Module):
    ...
    def __init__(self, configs,
        ...
        hidden_dim = [configs.d_model, configs.d_ff, configs.d_ff, configs.d_model]
        kernel_size = (1, 1)
        num_layers = 4
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        layer_output_list = layer_output_list.squeeze()

        output = layer_output_list.reshape(layer_output_list.shape[0], -1)  # (batch_size, seq_length * d_model)
